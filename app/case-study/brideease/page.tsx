...
const sections = [
  ...
  { id: "02", label: "Problem Statement",         file: "02-problem.jpg" },
  { id: "03", label: "User Personas",             file: "03-personas.jpg" },
  { id: "04", label: "User Journey Maps",         file: "04-journey.jpg" },
  { id: "05", label: "Information Architecture",  file: "05-ia.jpg" },
  { id: "06", label: "User Flows",                file: "06-flows.jpg" },
  { id: "07", label: "Wireframes",                file: "07-wireframes.jpg" },
  { id: "08", label: "High-Fidelity UI",          file: "08-hifi.jpg" },
  { id: "09", label: "Design System",             file: "09-design-system.jpg" },
  { id: "10", label: "Outcome & Impact",          file: "10-outcome.jpg" },
  { id: "11", label: "Learnings",                 file: "11-learnings.jpg" },
  { id: "12", label: "Thank You",                 file: "12-thankyou.jpg" },
];

const IMG_BASE = "/images/case-studies/brideease";
...
/* ── Component ── */
export default function BrideEaseCaseStudy() {
                ...
                {isHero && (
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      viewport={{ once: true }}
                    >
                      {["UI/UX Designer", "4 Weeks", "Figma", "2026"].map(
                        (item, i, arr) => (
